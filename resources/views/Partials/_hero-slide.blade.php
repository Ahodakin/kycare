                ...
                <div class="col-12">
                   <!-- Slide Content Start -->
                    <div class="content style text-center">
                        ...
                        <!-- Formulaire -->
                        <form action="rechercher.php" method="POST" class="mt-4">
                            <div class="form-row justify-content-center">
                                <div class="form-row justify-content-center">
                                    <div class="col-lg-6 md-4">
                                        <label for="practitioner" style="color: #fff;">Rechercher un praticien</label>
                                        <input type="text" id="practitioner" name="practitioner" class="form-control main" placeholder="Nom, spécialité" required>
                                    </div>
                                    <!-- Localisation -->
                                    <div class="col-lg-6">
                                        <label for="location" style="color: #fff;">Localisation</label>
                                        <input type="text" id="location" class="form-control main" placeholder="Abidjan" required>
                                    </div>
                                    <div class="col-md-12 mt-3 text-right">
                                        <button class="btn btn-style-one" type="submit">Rechercher</button>
                                    </div>
                                </div>
                            </div>
